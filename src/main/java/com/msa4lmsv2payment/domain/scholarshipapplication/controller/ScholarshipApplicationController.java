...
public class ScholarshipApplicationController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "신청기간이 아님"),
            @ApiResponse(responseCode = "403", description = "본인 고지가 아님"),
            @ApiResponse(responseCode = "404", description = "존재하지 않는 고지 또는 신청기간 미설정"),
            @ApiResponse(responseCode = "409", description = "이미 심사 중인 신청이 있음")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "반려 사유 누락 또는 장학금 합계 초과"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "조회 성공"),
            @ApiResponse(responseCode = "404", description = "신청기간 미설정")
    })
