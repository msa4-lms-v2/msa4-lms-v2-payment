...
public record PgPaymentRequestDTO(
        ...
        @Schema(description = "토스페이먼츠 결제위젯이 발급한 결제 키", example = "tgen_20260813_001", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "paymentKey는 필수입니다.") String paymentKey,
        @Schema(description = "결제 금액. 서버 저장값 또는 토스 응답 금액과 다르면 400 E21 또는 409 E11", example = "4200000", requiredMode = Schema.RequiredMode.REQUIRED)
