...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalResponseDTO<Void>> handleBusinessException(BusinessException e) {
    ...
    public ResponseEntity<GlobalResponseDTO<Void>> handleValidException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.status(CustomResponseCode.INVALID_PARAMETER.getHttpStatus())
                .body(GlobalResponseDTO.fail(CustomResponseCode.INVALID_PARAMETER, null));
    }

    @ExceptionHandler(ConstraintViolationException.class)
    public ResponseEntity<GlobalResponseDTO<Void>> handleConstraintViolationException(ConstraintViolationException e) {
    ...
    public ResponseEntity<GlobalResponseDTO<Void>> handleMissingRequestHeaderException(MissingRequestHeaderException e) {
    ...
    public ResponseEntity<GlobalResponseDTO<Void>> handleAccessDeniedException(AccessDeniedException e) {
        ...
        return ResponseEntity.status(CustomResponseCode.ACCESS_DENIED.getHttpStatus())
                .body(GlobalResponseDTO.fail(CustomResponseCode.ACCESS_DENIED, null));
    }
    ...
    public ResponseEntity<GlobalResponseDTO<Void>> handleException(Exception e) {
        ...
        return ResponseEntity.status(CustomResponseCode.SYSTEM_ERROR.getHttpStatus())
                .body(GlobalResponseDTO.fail(CustomResponseCode.SYSTEM_ERROR, null));
    }
}
